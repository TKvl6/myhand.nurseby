module.exports = [{
  ...
  },
  {
    code: 143,
    name: '로타 바이러스 감염증',
    cause: '로타 바이러스 감염증은 레오바이러스과에 속하는 로타 바이러스에 의해 나타난다. 로타 바이러스는 감염 후 임상증상이 나타나기 전부터 ���상이 없어진 후 10일까지 감염된 사람의 대변에 존재한다. 감염된 사람이 증상을 보이지 않더라도 로타 바이러스는 이 기간 동안 손과 입을 통해 쉽게 전파될 수 있다. 화장실에서 변을 본 후 또는 아이의 기저귀를 교환한 후 손을 씻지 않으면 바이러스는 그 손을 통해 다른 사람에게 전파될 수 있다. 때때로 오염된 물이나 감염된 비말을 통해서도 바이러스가 전파된다',
    symptom: '구토,발열,대변',
