...

{
  ...
  symptom: '피로,메스꺼움,구토,식욕부진,발열,통증,황달,대변,소변',
...

{
  ...
  symptom: '궤양,피부이상,발열,붓기,통증, 가려움',
  core_symptom: '궤양,피부이상, 가려움',
  part: '생식기,근육,목,림프절,임파선,피부',
  desc: '성 접촉',
  /* 이미지 수정 필요 */
...
},
{
  code: 12,
  name: '요로결석',
  cause: '수분 섭취 감소는 요로결석의 가장 중요한 발병 원인이다. 수분의 섭취가 감소하면 요석결정이 소변에 머무르는 시간이 길어져 요석형성이 증가하게 된다. 요로결석의 발생은 유전적인 소인이 있다는 것이 정설이나 후천적인 생활습관도 연관성을 보인다. 남성이 여성에 비해 2-3배 발생 위험성이 높고, 20~40대의 젊은 연령층에서 잘 발생하였으나 최근 고령층에서 발생이 증가하고 있다.\n요로결석은 지리적으로 산이 많은 지역, 사막, 열대 지방에서 많이 나타나는데, 이는 음식, 온도, 습도 등이 복합적으로 작용하기 때문이라고 생각된다.온도와 계절은 요로결석 발생에 중요한 요인으로 작용하는데, 여름에는 땀을 많이 흘리면서 소변이 농축되어 요로결석의 생성이 용이해진다. 햇볕에 많이 노출되면 비타민D의 형성이 증가되어 요로결석의 위험이 증가한다는 보고도 있다. 동물성 단백질 섭취 증가도 요중 칼슘, 수산, 요산의 배설을 증가시켜 요로결석의 위험을 증가시킨다',
...
},
{
  code: 19,
  name: '알레르기 비염',
  cause: '알레르기 비염은 알레르기 천식과 함께 유전적 요인과 환경적 요인이 합쳐져서 생기는 대표적인 알레르기 질환으로, 부모로부터 물려받은 알레르기 체질과 주위의 천식 유발 요소들이 상호 작용을 일으켜 나타난다. 알레르기란 정상에서 벗어난 과민반응을 의미하며 정상인에게는 증상이 유발되지 않지만 알레르기 환자에게는 과민반응으로 여러 증상이 나타나는 것을 말한다. 비염을 악화시키는 대표적인 악화요인은 기후변화, 감기, 공기오염, 스트레스 등이 있다.\n1) 나이와 가족력환자의 75% 정도가 25세 이전에 증상이 시작되는 것으로 볼 때 항원에 대한 감작(sensitization, 생체가 민감한 상태)은 소아기에 일어날 것으로 추정된다. 알레르기 환자가 있는 집안에서 태어난 유아에 있어서 생후 10년간은 가장 위험도가 높은 시기이다. 부모 중 한 쪽에 알레르기가 있을 때 자녀가 알레르기 질환에 걸릴 가능성은 50% 정도이며 양 부모가 알레르기 질환을 가지고 있다면 확률은 약 75%로 증가한다. 아토피성 피부염, 기관지 천식 및 알레르기 비염을 3대 알레르기 질환이라 하며 어린 나이부터 순차적으로 발병하기 때문에 이러한 일련의 발병을 알레르기 행진이라 한다.\n2) 항원알레르기 비염을 유발하는 원인 항원을 알레르겐이라고도 한다. 집먼지 진드기, 꽃가루, 곰팡이, 애완동물의 털 혹은 비듬, 바퀴벌레 따위의 곤충 부스러기 등과 같이 호흡기를 통해 흡입되는 것들이 대표적이지만, 음식물, 음식물 첨가제, 약물 등에 의해서도 알레르기 비염이 유발될 수 있다. 알레르기에 대한 유전성이 있는 사람 중 얼마나 많은 사람이 알레르기 환자가 되는지는 확실하지 않다. 소아가 아토피 성향을 가지고 있을 때 장기간 항원에 노출된 다음에 증상이 나타나므로 항원에 대한 노출을 피하는 것은 감작이 일어나는 영유아기에 특히 의미가 있다.\n3) 환경지나치게 깨끗한 환경, 형제가 적은 가정 등이 알레르기 질환의 유병률을 증가시킨다. 어린 시절 여러 종류의 미생물에 노출되는 것이 과도한 알레르기 면역반응을 예방하는 것이다. 농촌 지역에서는 항원으로 작용할 수 있는 동물이나 식물이 생활환경 주변에 많이 있음에도 불구하고 농촌 지역의 주민 중 알레르기 질환의 유병률이 인근 도시 지역의 유병률보다 낮은 것은 특기할 만 하다.\n4) 호흡기 감염바이러스 감염은 천식 증상을 유발하는 것으로 나타났지만 알레르기 비염에 대한 영향은 명확하지 않다',
...
},
{
  code: 32,
  name: '섬유근육통',
  cause: '섬유근육통의 원인은 아직 밝혀지지 않았지만 통증에 대한 지각이상 때문인 것으로 생각된다. 섬유근육통을 앓는 사람의 중추신경계에서 세로토닌의 대사가 감소되어 있고, 체내의 성장호르몬의 분비도 감소되어 있으며, 스트레스에 대한 부신피질호르몬의 분비 반응 감소, 뇌척수액에서 P 물질(substance P, 통증 유발 물질)의 증가, 자율신경계의 기능 부전 등의 이상이 있다는 것이 밝혀져 있다.\n섬유근육통 환자들은 정상인들이 통증으로 느끼지 않는 자극을 통증으로 느끼게 되는데, 이것은 여러 가지 통증과 상관이 없는 자극에 대해서 몸이 적절히 처리하지 못하기 때문이라고 여겨진다. 또한 여러 가지 정신적인 이상-우울증, 불안, 건강 염려증 등이 동반되어 나타나는데, 섬유근육통 환자의 약 30%가 정신과적인 질환 증상을 보인다. 근육이나 인대, 힘줄 등에서 객관적인 이상은 발견되지 않는다',
  symptom: '근육통, 통증, 피로, 불면',
  core_symptom: '근육통,통증,불면,피로',
  part: '근육',
  desc: '특별히 다친 곳이 없음',
  /* 이미지 수정 필요 */
  img: 'https://raw.githubusercontent.com/TKvl6/myhand.nurseby/master/myhand.nurseby/assets/icon_png/004-allergologist.png',
...
},
{
  code: 34,
  name: '급성 비염',
  cause: '대부분 바이러스가 주 원인이며 대표적인 바이러스로 비염바이러스(rhinovirus)와 코로나바이러스(coronavirus) 등이 있다. 이들이 전형적인 급성 비염의 경과를 밟는 데 반해, 인플루엔자바이러스에 의한 감염은 좀 더 심한 전신 증상을 포함한 임상 경과를 거친다. 여기에 추운 날씨, 낮은 습도, 영양부족, 과로, 스트레스, 비타민 결핍, 면역기능저하 등이 급성 비염의 발생과 관련이 있다.\n환절기나 겨울철에 감기가 많이 발생하는 이유는 추운 날씨로 인해 실내 공기의 환기가 부족하고 여러 사람들이 모여 바이러스의 전파의 가능성이 높기 때문이다.또한 건조한 실내 공기로 인해 비강점막의 점액층에 섬모운동에 장애를 초래하여 심한 비강 기능 저하를 가져올 수 있다. 다른 환자의 재채기, 기침 등을 통해 나오는 감염된 분비물 등이 코 안으로 들어가서 염증을 초래하지만 때로는 입맞춤, 음식 또는 손으로 직접 전파되기도 한다. 또한 급성 비염을 일으키는 감염원으로 아데노이드염, 편도선염, 부비동염(축농증) 등이 있다',
  symptom: '두통, 오한, 식욕 상실, 코막힘, 후각 감퇴',
  core_symptom: '콧물, 오한',
  part: '코,머리',
  desc: '갑자기 코가 자주 막힘',
  img: 'https://raw.githubusercontent.com/TKvl6/myhand.nurseby/master/myhand.nurseby/assets/icon_png/077-runny_nose.png',
...
},
{
  code: 37,
  name: '설염',
  cause: '급성 설염은 외상, 치아 등 구강의 염증이 혀에까지 파급되어 나타나는 경우가 대부분이다. 가장 흔한 원인균은 연쇄상구균과 포도상구균이며, 가장 흔한 설염의 종류는 면역력이 떨어졌을 때 생기는 카타르성설염이다.\n그 밖에도 입안의 위생 상태가 불량할 때, 비타민 부족일 때, 혀에 상처가 생겼을 때, 특히 내분비 장애가 잘 조절되지 않으면 진균성 감염이 나타날 수 있다',
  symptom: '붓기,통증,감각이상',
...
},
{
  code: 39,
  name: '사람면역결핍바이러스',
  cause: 'HIV는 다시 1형 (HIV-1)과 2형(HIV-2)로 구분하며 전 세계적으로 확산되어 HIV 감염을 일으키고 있는 것은 HIV-1입니다. HIV-2는 주로 아프리카 일부 지역에만 분포하고 있습니다.\nHIV의 감염경로는 대부분 성 접촉이고 드물게 수혈이나 혈액 제제를 통한 전파, 병원 관련 종사자에서 바늘에 찔리는 등의 사고를 통한 전파, 감염된 산모로부터 신생아로 전파 등이 일어날 수 있습니다',
...
},
{
  code: 84,
  name: '기흉',
  cause: '80%의 환자가 컴퓨터단층찰영(CT)에서 폐첨부에 기종성 변화를 보인다.이차성 기흉은 폐실질에 발생한 질환이 원인이 되는 기흉을 말하는데, 교통사고나 추락, 외상에 의한 폐실질의 손상으로 발생하는 외상성 기흉, 수술이나 중심정맥 삽관술 같은 시술 중의 폐실질 손상으로 발생하는 의인성(인위적으로 유발된) 기흉 등이 있다.\n이차성 기흉의 가장 흔한 원인은 만성 폐쇄성 폐질환이나 폐기종 등 폐에 질환을 앓고 있는 경우이며, 결핵, 악성 종양, 사르코이도시스, 낭성섬유증, 원발성 폐섬유증 등이 그 원인이다. 전형적으로 50대 이상의 환자에게 많이 발생하며 진단이 어려울 수도 있다. 거대 기종과의 감별이 필요한 경우도 있으며 때론 악성 종양이 원인이 되기도 한다. 드물게 에이즈 감염자에게서 뉴모시스티스 카리니 폐렴과 관련되어 기흉이 증가한다고도 알려져 있다. 또한 결핵과 바이러스 감염, 괴사성 세균성 폐렴에서도 기흉이 발생할 수 있다. 유전학적인 요인도 최근 밝혀지기 시작했으며 가족력도 관련있는 것으로 보고되고 있다. \n외상성 기흉은 흉막강 내에 단일 방향으로만 공기가 유입되는 상태가 만들어지는 경우가 많아 종격동(양쪽 폐와 심장 사이의 공간)과 심장이 한쪽으로 밀려 혈압이 떨어지고 심폐 기능에 이상이 발생하는 긴장성 기흉이 생기기도 한다. 중환자실에서 인공호흡기 등 기계에 의한 양압호흡으로 인해 긴장성 기흉이 유발되기도 한다.\n여성에게는 월경과 관련되어 기흉이 발생하기도 하는데, 월경 시작 후 48~72시간 내에 생기며 경구 피임약 복용으로 배란이 일어나지 않을 때는 절대 발생하지 않는다는 특징이 있다',
  symptom: '통증, 호흡곤란, 답답',
  core_symptom: '통증,답답',
  part: '폐,가슴',
  desc: '흡연자',
...
},
{
  code: 102,
  name: '수신증',
  cause: '다양한 원인에 의하여 요로계의 폐쇄가 일어나 수신증이나 수신요관증이 발생할 수 있다. 소아에서는 선천적인 기형이 흔한 원인이다. 선천적으로 요관과 신우 경계 부위가 좁아져 있거나, 요관과 방광 경계 부위가 좁아져서 발생하는 경우가 흔하며, 비정상적인 요관의 위치(대정맥 하방에 위치하여 눌림)로 인하여 발생하기도 한다. 어린 남아에서는 요도를 막는 후방 요도 판막(posterior urethral valve)이 양측성 수신증의 흔한 원인이다. 방광 기능의 장애 때문에 발생하기도 하는데, 이는 선천적인 요도의 협착이나 요도 출구나 방광 경부의 폐쇄로 인하여 이차성으로 발생하는 것으로 생각된다. 성인에서의 요로 폐쇄는 대개 후천적 원인에 의해 발생하는데, 신우의 종양이나 요로계 결석, 요도의 협착이 흔한 원인이다. 골반이나 대장 수술 중에 요관을 묶거나 손상을 주어 발생하는 일측성 수신증은 대개 무증상으로 오랫동안 발견되지 않을 수 있다.\n또한 요로계 자체에 생긴 폐쇄가 아닌 외부 물질의 압박으로 요로계가 막혀 수신증이 발생할 수 있다. 자궁경부암이나 대장암인 경우 암 덩어리에 요로계가 눌려 발생할 수 있고, 기타 다른 악성 종양에 의해서도 막힐 수 있다. 중년 이상의 남성에서는 전립샘 비대증이나 전립샘암이 흔한 원인일 수 있지만, 염증성 질환인 후복막강 섬유화증도 수신증의 원인이 될 수 있다. 임신 중에는 태아에 의해 요관이 눌리게 되기 때문에 수신증이 발생하기도 한다. 기계적인 폐쇄가 아닌 기능적인 요로계 폐쇄로 인하여 수신증이 나타날 수 있는데, 대개 요관과 방광 질환에 의하여 발생한다.\n그 외에도 당뇨병에 의한 합병증이나 척수 손상으로 인한 신경인성 방광도 흔한 원인이며, 요관 무력증(adynamic ureter)이 동반되기도 한다. 방광요관역류에 의해서도 수신증이 발생한다. 이는 소아에서 더 흔하며 심한 수신요관증을 초래할 수 있다. 요관의 방광 삽입부(요관과 방광이 이어지는 부분)에 이상이 생기면 방광요관역류 흔하게 발생하고, 염증이 없고, 방광 경부가 막히지 않은 경우에는 신실질에 손상을 주지 않으며, 나이가 들면서 저절로 좋아지기도 한다',
...
},
{
  code: 109,
  name: '추간판 탈출증',
  cause: '나이가 들면서 추간판은 퇴행성 변화를 필연적으로 겪게 되고, 10대 후반이나 20대 초반부터 이런 과정들이 나타날 수 있다. 추간판이 퇴행됨에 따라 추간판의 가장자리를 둘러싸고 있는 섬유륜에 균열(fissure)이 발생하게 되고 추간판 내부의 수핵이 척추뼈의 경계 넘어로 탈출될 수 있다. 추간판의 퇴행을 가속화시키는 몇 가지 요인들이 알려져 있는데, 이를 예방하기 위해 요추 전만 유지의 중요성이 날로 강조되고 있다. 추간판에 가해지는 하중을 효율적으로 분산시키기 위해 정상적으로 경추 및 요���에 존재하는 전만 곡선이 무너지는 경우, 즉 목이나 허리가 굴곡된 자세 혹은 동작을 장기간 취할 경우, 추간판에 가해지는 압력이 증가하여 손상이 가속화 된다. 이외에 유전성도 추간판 퇴행에 중요한 인자로 알려져 있다',
...
},
{
  code: 113,
  name: '수근관 증후군',
  cause: '이론적으로는 수근관의 단면을 감소시킬 수 있는 어떤 경우라도 원인이 될 수 있으나, 대부분의 경우에서 정확한 원인은 발견되지 않습니다. 수근관을 덮고 있는 인대가 두꺼워져 정중신경을 압박하게 되는 것이 가장 흔한 원인입니다. 원인이 비교적 잘 알려진 경우들에는 수근 관절 주위의 골절이나 탈구 및 그 후유증, 감염이나 염증성 질환 또는 외상으로 인한 부종이나 건막의 증식 그리고 수근관 내에 발생한 종양 등으로 인한 눌림이 있습니다.\n손목 부위의 골절 및 탈구로 수근관이 좁아져서 정중 신경이 눌리면서 증상이 나타날 수 있으며, 이러한 골절이 잘못 붙거나(부정유합) 및 붙지 않는(불유합) 등의 후유증으로 처음에는 증상이 없었으나 시간이 지나면서 증세를 보이는 지연성의 경우도 있을 수 있습니다. 감염이나 류마티스성 관절염 또는 통풍 등 활액막염을 초래하는 질환에서는 수근관 속에서 굴곡건 활액막이 붓거나(종창) 증식되어 정중신경을 누를 수 있습니다. 일부 전신성 아밀로이드증(generalized amyloidosis) 등에서 특정 단백질이 손목 인대에 침착되어 발생하기도 합니다.여성, 비만, 노인, 당뇨병 환자에게서 더 흔하게 발생합니다.\n임신 중에만 일시적으로 이 증후군이 나타나기도 하며, 남녀 모두에게 발생하지만 40~60세 사이에서 가장 흔히 발생하고, 중년 이후의 여성에게 호발합니다. 만성 신부전으로 투석을 받는 환자에서도 흔히 발생합니다.  ',
...
},
{
  code: 117,
  name: '중동 호흡기 증후군(메르스)',
  cause: '중동 지역의 낙타와의 접촉을 통해 감염될 가능성이 높고, 사람 간 밀접접촉에 의한 전파가 가능하다.\n* 밀접접촉 : 확진 또는 의심환자를 돌본 사람(의료인, 가족 포함), 환자 및 의심환자가 증상이 있는 동안 동일한 장소에 머문 사람(방문, 동거 등',
  symptom: ' 발열,기침,호흡곤란,가래,통증,오한,코막힘,식욕부진,메스꺼움,구토',
...
},
{
  code: 119,
  name: '건선',
  cause: '건선의 원인은 아직 완벽하게 밝혀져 있지는 않지만 피부에 있는 면역세포인 T세포의 활동성이 증가되어 그 결과 분비된 면역 물질이 피부의 각질세포를 자극하여 각질세포의 과다한 증식과 염증을 일으키는 것으로 밝혀지고 있습니다. 피부 세포가 빠르게 자라나고 정상적인 분화에 장애가 발생되어 피부 위에 비듬 같은 각질이 겹겹이 쌓여서 보이게 됩니다.\n이러한 현상이 발생됨에 있어서 유전적 요인, 환경적 요인, 약물, 피부자극, 건조, 상기도 염증, 정신적 스트레스 등이 원인이 되거나 악화시키는 요인으로 알려져 있습니다',
  symptom: '피부이상,각질',
...
},
{
  code: 124,
  name: '간농양',
  cause: '간농양은 감염을 일으키는 원인 미생물이 세균이냐, ‘아메바’라는 기생충이냐에 따라 나뉜다. 세균에 의한 간농양은 ‘화농성 간농양’이라고 부르고, 아메바에 의한 간농양은 ‘아메바성 간농양’이라고 부른다.현재 우리나라에서 발생하는 간농양은 대부분 화농성 간농양이다. 화농성 간농양은 간에 들어온 세균을 면역 세포들이 초기에 제거하는 데 실패한 경우에 발생하게 되며, 이렇게 면역 기능이 저하된 경우가 간농양의 원인이 될 수 있다. 현재 화농성 간농양의 가장 흔한 원인은 간에서 생산된 담즙이 배설되는 경로인 담관을 세균이 역행하여 침범하는 경우이다. 따라서 이 부위에 담석증, 간내 결석증, 담도 악성 종양 등 담도계 질환이 발생하거나 간이식 수술 등 이 부분의 구조가 바뀌는 수술을 하는 경우, 정상적으로 세균의 침입을 막던 구조가 손상되어 세균이 침범하고 화농성 간농양이 발생할 수 있다.\n한편, 이 부위는 구조적 변화 없이도 당뇨병, 만성 콩팥병(만성 신질환), 간경변증과 같은 만성 질환이 있는 경우에도 면역 기능이 저하되어 세균의 침입을 막지 못하고 화농성 간농양이 쉽게 발생할 수 있다.\n아메바성 간농양은 이질 아메바(Entamoeba histolytica)라는 기생충에 의해서 발생한다. 이질 아메바에 이미 감염된 환자의 대변으로 오염된 물이나 음식을 먹으면 감염된다. 이 기생충이 장염 다음으로 흔하게 일으키는 감염이 간농양으로, 장에서 혈액의 흐름을 따라 간까지 침범하여 감염을 일으키고 고름집을 형성하는 것이다. 우리나라도 과거 위생 환경이 좋지 않던 시절에 아메바성 이질과 아메바성 간농양이 종종 발생하였으나, 현재는 거의 발생하지 않으며, 사하라 사막 이남의 아프리카, 동남아시아, 멕시코, 남아메리카 일부 등 위생 환경이 좋지 못한 개발도상국에서 살다가 왔거나 이 곳들을 여행한 젊은 사람들에게 주로 발생한다',
...
},
{
  code: 135,
  name: '고혈압성 신장 질환',
  cause: '신장은 혈압을 조절하는 혈압조절 본부이며 혈압과 신장은 뗄래야 뗄 수 없는 관계이다. 따라서 고혈압은 신장 질환의 원인인 동시에 결과이다. 즉, 혈압이 높아지면 신장의 사구체 내의 작은 신장 단위들이 손상을 입어 신장 기능이 빠르게 저하되고, 반대로 신장 기능이 손상되어 있으면 혈압 조절이 잘 되지 않아 고혈압이 생긴다. 실제로 신부전 환자의 85%에서 고혈압이 발견된다.\n고혈압이 만성적으로 있었던 경우, 특히 혈압이 잘 조절되지 않은 경우에는 신장에 분포하는 혈관 벽이 두꺼워지고, 두꺼워진 혈관벽에 단백질이나 지방 등이 침착하여 혈액의 흐름을 방해하여 사구체가 손상되고 이로 인해 신장 기능이 저하된다. 따라서 항고혈압제로 혈압만 잘 조절해도 신장 질환의 진행속도를 늦출 수 있다',
...
},
{
  code: 138,
  name: '급성 대장염',
  cause: '급성 장염을 일으키는 원인은 다양한 종류의 세균, 바이러스, 원충으로 이들에 오염된 식품이나 물을 먹어서 감염된다. 바이러스 중 노로바이러스와 로타바이러스에 의한 장염이 전체의 20%를 차지하고 연중으로 발생하며 특히 겨울철에 유행하고 있어 이에 대한 주의가 필요하다. 노로바이러스는 매우 높은 전염력을 보여 급식에 의한 집단 식중독 사례를 일으킨 것으로도 유명하다.\n세균성 장염의 원인균으로는 장티푸스를 일으키는 살모넬라, 세균성 이질을 일으키는 쉬겔라, 콜레라를 일으키는 비브리오, 출혈성 장염을 일으키는 대장균, 이외에 캠필로박터, 예르시니아, 클로스트리디움 등이 있다. 원충으로는 대표적으로 아메바 가 있다. 이 외에 약제 복용 후 발생하는 위막성 장염이 있다',
...
},
{
  code: 140,
  name: '외상성 고관절탈구',
  cause: '고관절은 우리 몸에서 가장 안정된 관절로 탈구를 일으키려면 강한 힘을 받아야 하고, 이 때문에 골절을 동반하는 경우가 흔하다. 외상성 고관절 탈구의 원인은 교통사고, 높은 곳에서의 낙상, 작업 중 사고, 스포츠 손상 등으로 발생할 수 있으며, 다른 신체 부위의 손상을 동반하는 경우가 흔하다. 따라서 다발성 손상을 당한 경우나 큰 외상을 받은 환자는 고관절 탈구에 대한 검사를 실시해야 한다.\n고관절 탈구는 해부학적 구조상 약 85~90%가 후방 탈구로 발생하며, 이는 특히 교통사고 시 계기판에 직접 부딪히는 외상이나, 의자에 앉아있는 자세(무릎과 고관절을 구부린 상태)로 무릎 전방에 직접적인 충돌이 가해지는 낙상 등에서 잘 일어난다',
  symptom: '골절,출혈',
  core_symtom: '골절',
  part: '관절',
  desc: '골반 쪽 심한 통증',
...
},
{
  code: 145,
  name: '납 중독',
  cause: '납은 식품, 음료뿐만 아니라 오염된 대기, 납이 함유된 토양, 환경개선이 되어 있지 않은 산업 시설에서 나오는 분진, 자동차 매연, 납이 함유된 페인트, 납으로 오염된 위스키 등을 통해 노출될 수 있다. 납의 체내 흡수는 소화기를 통한 섭취와 호흡기를 통한 흡입으로 이루어진다. 납을 원료로 사용하는 작업장을 살펴보면, 크리스탈 유리 제조 공정, 자동차 수리 작업장, 납 광산, 납땜 작업장, 도자기 작업장 등 납을 원료로 사용하는 공장 등이 있다. 이러한 공장에서 증기나 미세한 먼지를 지속적으로 들이마시면 납 중독의 위험이 현저하게 높아진다.\n곡류, 과일, 야채류 등은 토양에서 납을 흡수하거나 공기 중의 납에 노출되면서 오염될 수 있다. 또한, 납으로 만들어진 수도관을 타고 나오는 수돗물을 마시거나 오염된 물로 만들어진 음료수를 지속적으로 마시면 납에 노출될 수 있다. 대기 중의 납 농도는 계절, 지역에 따라 상당한 차이가 있으며 한 지역에서도 교통량, 날씨, 온도 등에 따라 그 정도가 달라진다.\n일반적으로 도시 근교에서 납 농도가 높으며 폐쇄된 주차장이나 교통량이 많은 도로는 매연이 많아 납 농도가 매우 높다. 토양은 납에 직접적으로 노출되어 있으며 물속으로의 납 노출은 자연적으로 납을 포함하고 있는 토양과 암석, 산업시설 및 자동차에서 오염된 물질이 송수관 등을 통해 배출되면서 이루어진다. 납이 페인트 원료로 사용되었다면 페인트가 벗겨지거나 조각나서 주변을 오염시킬 수 있다. 또한, 납을 함유한 유약을 사용한 도제 용기, 폐기된 건전지, 납 페인트로 칠해진 어린이용 완구와 가구, 그림도구, 의약품, 사격장의 분진을 통해서도 납에 노출될 수 있다',
...
},
{
  code: 148,
  name: '신장 결핵',
  cause: '신장 결핵을 포함한 요로계 결핵의 원인은 대부분 결핵균이다. 결핵균은 리본과 같은 간균의 형태로 호기성이며, 약하게 그람 염색과 항산성 검사에서 양성을 나타낸다. 정상적으로 결핵균이 체내에 침범하면 대식세포에 의해 포식되어 내부에서 lysosome에 의해 분해 및 제거되어야 한다. 그러나 일부의 균은 이러한 분해 및 제거 과정을 회피하고 대식세포 내에서 생존하게 된다. 건강한 사람에서는 T 림프구를 중심으로 하는 세포성 면역반응이 잔존한 결핵균이 활성화되지 못하도록 제어하고 있으나, 이러한 면역 반응이 불충분한 경우에 결핵균에 의한 장기 손상이 발생하게 된다. 결핵균 외에도 아비움 인트라셀루라레, 칸사시, 보비스, 포푸이툼 등이 있으나 대개는 임상 질환을 일으키지 않으며, 앞서 말했듯이 가장 흔한 원인균은 결핵균이다. 결핵의 임상 양상은 병원균의 병독성과 숙주의 반응에 의해 결정된다. 1~5μm 정도 크기의 결핵균 비말이 호흡기계와 편도선, 위장관계에 들어오면 대개 무증상의 육아종을 형성하게 되나 일부 국소 림프절에 있던 균이 흉선을 통해 전신 순환을 하게 되면 혈행(피의 흐름)을 따라 전파될 수 있다.\n신장 결핵이 폐결핵과 동시에 나타나는 경우는 결핵균의 혈행 전파로 발생하며, 이 때문에 주로 혈류와 산소포화도가 높은 신장의 피질을 주로 침범하게 되고, 양측에 다발성의 육아종을 형성하며 발생한다. 이후 수년 동안 무증상으로 남아 있거나, 근위 세뇨관으로 터져나가면서 결핵균이 증폭될 수 있다. 신장 결핵이 잠복상태의 결핵균이 재활성화되는 경우에는 대개 한쪽 신장 및 요로에서 발생하게 된다. 전립선과 부고환에도 침범할 수 있는데, 이경우는 대개 혈행 감염으로 발생한다. 소변을 통해 결핵균이 빠져나가면서 요관과 방광에 이차적인 감염을 유발할 수 있다. 신장 침범이 60-100%, 요관 침범은 19-41%, 방광 침범은 15-20%이며, 남자에서 전립선 및 부고환의 침범은 20-50%로 알려져 있다',
...
},
{
  code: 153,
  name: '중증 급성 호흡기 증후군',
  cause: '사스의 원인 바이러스인 사스-코로나 바이러스는 한 가닥의 RNA를 유전물질로 가지고 있는 바이러스이다. 인간에게 감염을 일으키는 코로나 바이러스의 형태는 제1혈청형과 제2혈청형이 알려져 있는데, SARS의 원인이 되었던 코로나 바이러스는 이 두 가지 혈청형과 다른 새로운 종류인 것으로 나타났다. 원인 바이러스가 전파되는 경로는 아직 완전히 밝혀지지 않았지만 대기 중에 떠다니는 고체나 액체의 미세한 입자에 의해 전파되는 것으로 추측하고 있다',
...
},
{
  code: 158,
  name: '반응성 관절염',
  cause: '반응성 관절염의 정확한 원인은 아직 밝혀지지 않았지만 감염 이후 발생하는 자가면역기전이 주요기전으로 알려져 있다. 자가면역이란 외부로부터 인체를 지키는 면역계에 이상이 생겨 오히려 인체를 공격하는 현상으로, 감염균에 대항하기 위해 활성화되는 면역 체계가 감염균 뿐만 아니라 정상적인 체내의 관절 및 관절 주위 조직에 대해 공격하는 것이다.\n이러한 자가면역기전의 발생에 유전적 소인이 많은 관여를 하고 있다고 여겨지며, 가장 대표적으로 사람백혈구항원이라고 하는 HLA-B27(Human Leukocyte Antigen-B27)을 들 수 있는데, 이러한 유전적 소인이 있는 경우 반응성 관절염의 발생 위험도가 높아지거나, 관절염이 더 심하고 오래가는 경향성을 보인다',
...
},
{
  code: 170,
  name: '무릎 관절염',
  cause: '증상이 있는 슬관절 관절염은 60세 이상의 남성에서 9.6%, 여성에서는 18%에서 발생하는 것으로 알려져 있다. 미국의 경우 슬관절에서 45세 이상의 경우 19.2%에서 27.8%까지 방사선학적으로 관찰되며, 60세 이상의 경우에는 37%에서 방사선학적으로 관찰되는 관절염이 발생하였다고 보고하였다. 유병률은 연령과 함께 증가한다. 관절염 발생의 위험인자는 전신적인 위험 인자와 국소적인 위험 인자로 분류할 수 있다. 전신적인 위험 인자는 인종, 연령, 성별, 비만, 호르몬 변화, 유전적인 영향, 골밀도, 영양 상태 등이 있고, 국소적인 위험 인자는 관절의 생역학적 변화, 관절 손상, 직업, 스포츠, 육체적 활동, 발달성 이상 등이 있다. 골관절염의 발생 기전은 한 가지 위험 인자로 설명하기 어렵고 다양한 위험 인자가 복합적으로 작용한다. 노화는 모든 관절염의 관절염 발생에서 가장 중요함 위험 인자들 중 하나이며, 노령 인구의 증가에 따라 그 유병률도 증가하는 추세이다. 55세 이하에서는 남녀비가 유사하나, 나이가 많아질수록 여성에게서 더 많이 나타난다.분류일차성 또는 특발성과 이차성 또는 속발성으로 분류되어 왔다.\n일차성은 특별한 기질적인 원인이 없는 경우에 속하며, 이차성은 원인이 확실하게 증명되는 외상, 선천적 기형, 생화학적 이상이 동반된 경우 등이 속한다. 그러나 속발성이라고 진단되었더라도 원인을 밝히지 못하는 경우가 있을 수 있으며 동일 원인에 노출되어도 모두 관절염으로 진행하는 것은 아니다. 특발성도 최근에 그 원인이 조금씩 밝혀지고 있어 특발성과 속발성의 구분이 갈수록 더 불분명해지고 있다.  두 분류간의 임상적 진행의 중대한 차이는 없으며, 증상과 방사선학적 그리고 병리학적 상관관계의 차이도 뚜렷하지 않다',
  symptom: '통증,붓기',
  core_symptom: '통증',
  part: '무릎, 관절',
  desc: '날씨에 따라 통증이 달라짐',
...
},
{
  code: 180,
  name: '열사병',
  cause: '과도한 고온의 환경에 오랜 시간 노출되거나, 더운 상태에서 육체노동이나 운동을 지속할 때 시상 하부에 위치한 인체의 체온 유지 중추가 그 기능을 잃게 되면 열사병으로 진행한다. 정상적인 상태에서 인체가 고온 환경에 노출되면 시상하부 온도 조절장치와 관련된 온도 수용체에서 땀을 내고(발한), 피부의 모세혈관을 확장하며, 열 생산을 감소시키고, 심박출량을 증가시키며, 호흡을 증가시키는 것과 같은 기전으로 열을 몸 밖으로 발산하여 체온을 정상적인 범위 내에서 유지하게 된다. 그러나 이러한 보상 기전이 오랜 시간 지속되거나 한계를 벗어나면 시상하��� 온도조절 중추가 기능을 잃게 되고, 인체는 체온을 외부로 발산하지 못해 중추신경, 근육, 간, 콩팥 등의 다양한 장기가 영향을 받게 된다. 젊은 층에 많이 발생하는 운동성 열사병과 노인층에 주로 발생하는 고전적 열사병으로 나누기도 하나, 증상과 치료에는 별다른 차이가 없어 임상적으로 엄격히 구별하지는 않는다',
...
},
{
  ...
  symptom: '통증, 출혈, 전신 권태감, 피로, 식욕부진, 피하출혈, 혈뇨, 혈변,소변,대변',
...
},
{
  code: 206,
  name: '두통',
  cause: '안 좋은 자세, 목 척추병, 머리와 목 근육의 긴장, 근육 속 혈관의 수축, 스트레스, 불안, 우울증과 관련되어 있다. 긴장성 두통은 수면 중 10초 이상 숨을 쉬지 않는 수면 무호흡증, 약물, 과도한 음주, 카페인 섭취로 심해질 수 있다.',
  symptom: '두통, 발진, 저림',
  core_symptom: '두통',
  part: '머리, 뒤통수',
...
},
{
  code: 209,
  name: '급성 후두염 및 기관염',
  cause: '위산이 역류하면서 생기는 역류성 후두염, 바이러스 감염에 의한 경우에는 감염성 후두염이 있다. 역류성 후두염은 , 알레르기, 흡연, 음주 등이 원인이 될 수 있다. 성대를 너무 많이 사용함으로써 발생하며, 감염성 후두염은 주로 파라인플루엔자 바이러스로 인해 감염된다.',
  symptom: '염증, 호흡곤란, 호흡부전',
  core_symptom: '호흡곤란',
  part: '후두, 목',
...
{
  code: 213,
  name: '발목 및 발 부위의 관절 및 인대의 탈구, 염좌 및 긴장',
  cause: '관절의 운동이 허용된 범위를 벗어나는 경우, 예를 들면, 발목을 접질리는 경우, 공을 받으려 하다가 손가락이 뒤로 젖혀지는 경우는 인대가 다치게 된다. 염좌는 인대가 다친 것을 의미하는 것으로 가벼운 손상(인대의 부분 파열, 신연)에서부터 완전 파열까지의 다양한 정도의 인대 손상을 모두 포함한다. 그 손상 정도에 따라 1도에서 3도까지 구분할 수 있다.',
  symptom: '파열, 통증, 부종',
  core_symptom: '파열, 통증, 부종',
  part: '발목, 발, 인대, 관절',
...
},
{
  code: 227,
  name: '구내염',
  cause: '구강에 발생하는 통증을 동반하는 염증성 질환을 통틀어 구내염이라하며 구내염은 증상별, 발생 부위별, 원인별, 이학적 검사 소견에 따른 여러 가지 분류법들이 있으나 각 질환에 대하여 일률적으로 적용하기는 곤란하다. 따라서 대부분 이들의 여러 분류법들을 혼합하여 분류하는 경우가 많고, 일반적으로 구내염은 궤양성 구내염, 수포성 구내염, 미란성 구내염으로 나눈다.\n일반적으로 세균감염, 결핵감염, 매독감염, 곰팡이감염, 바이러스 감염과 같은 감염성 원인이 있고 또한 비타민 결핍(B12 및 C 등)과 철분결핍으로 인한 빈혈을 포함한 영양장애나 신체의 피로, 스트레스, 전신질환, 고열, 감기로 인한 면역장애와 위장장애, 그리고 구강내 위생의 불량, 충치, 외상 등이 발병 원인이 되기도 한다.',
  symptom: '통증, 치통',
  core_symptom: '통증, 치통',
  part: '구강, 입, 치아, 이빨',
...
},
{
  code: 230,
  name: '편두통',
  cause: '스트레스는 긴장형두통뿐만 아니라 편두통의 ��장 흔한 원인이지만 편두통이 발생하는 기전은 아직 명확하게 밝혀지지 않았다. 많은 연구자들은 뇌의 기능적인 변화, 신경전달물질 농도의 변화 및삼차신경과 그 주변혈관의 염증반응을 중요한 편두통의 발병기전으로 생각하고 있다. \n또한 두통 중에 동반되는 증상들이 많다. 체하면 머리가 아프거나 두통이 시작되면 소화가 안되거나 심할 때는 구토를 동반하기도 한다. ',
  symptom: '두통, 소화불량, 어지러움, 구토',
...
},
{
  code: 235,
  name: '골절',
  cause: '골절이란 외력에 의해 뼈가 부러지는 것을 지칭하며 뼈의 연속성이 완전 혹은 불완전하게 끊어지는 상태로 손상 부위의 상태에 따라 뼈가 피부 밖으로 튀어나온 경우인 개방성 골절, 골절 선이 여러 개가 있는 분쇄 골절 등으로 분류할 수 있다. 뼈에 가해진 외력을 견디지 못할 때 뼈는 부러지게 되는데 이러한 외력으로는 낙상, 자동차 사고, 추락 등이 있으며, 외력의 양상에 따라 골절의 형태가 달라지게 된다.',
  symptom: '근육통,통증, 압통, 부종, 감각이상, 근육떨림, 마비',
  core_symptom: '근육통,통증, 압통',
  part: '뼈, 근육, 전신',
  desc: '낙상, 자동차 사고, 추락 등',
  img: 'https://raw.githubusercontent.com/TKvl6/myhand.nurseby/master/myhand.nurseby/assets/icon_png/057-joint.png',
  score: 18
},
{
  code: 236,
  name: '자극접촉피부염',
  cause: '피부에 자극을 줄 수 있는 화학물질이나 물리적 자극물질에 일정한 농도 이상과 일정한 시간 이상의 노출을 주면 모든 사람에게 일어날 수 있는 피부염을 의미한다. 직업성으로 발생하는 경우가 많아 직업피부질환의 80%가 직업접촉피부염이다. \n자극접촉피부염이 잘 생길 수 있는 직업으로 가사노동자, 미용사, 의료종사자, 동물의료종사자, 청소근로자, 농업관련종사자, 원예나 수림산업종사자, 조리사, 금속가공업, 기계나 자동차 수리업, 건설근로자 등이 있다.',
  symptom: '따가움, 가려움, 피부이상',
...
},
{
  code: 237,
  name: '항문직장농양',
  cause: ' 항문과 직장 주위의 조직강에 염증이 발생하여 농양으로 발전한 것으로 가장 흔한 원인은 항문선의 감염이다. 또한 항문 부위의 수술, 외상 후나 당뇨병, 염증성 장질환에 의해 발생할 수 있다.',
  symptom: '통증, 배변장애, 배뇨통',
  core_symptom: '배변장애',
  part: '항문, 배',
...
},
{
  code: 239,
  name: '만성기관지염',
  cause: '만성폐쇄(성)폐질환은 점차적으로 기도가 좁아져 공기의 유출이 제한(비가역적 기도폐쇄)되는 질병이다. 병이 진행되면 두 세 질환의 임상증상 및 검사소견이 혼합되어 나타나는 양상을 보여 감별하기 힘든 경우가 많고, 치료법 역시 대동소이하여 총칭하여 만성폐쇄(성)폐질환이라 부른다. 기도폐쇄는 대개 점진적으로 진행되며 유해한 입자나 가스 등에 폐가 비정상적인 염증반응을 동반한다.',
  symptom: '기침, 가래, 기도폐쇄, 호흡곤란',
  core_symptom: '기침, 호흡곤란',
  part: '목, 기관지, 폐',
...
},
{
  code: 240,
  name: '패혈증',
  cause: '여러 가지 방법으로 몸 안에 침입한 다양한 미생물이 일으키는 중증 감염으로 여러 박테리아 특히 대장균, 녹농균, 클렙시엘라균이 주 원인이다. \n 침습성 시술, 인공기구의 사용이 증가하고, 그람음성균을 주 목표로 하는 경험적 항균제요법 등에 의해 다른 박테리아인 황색포도알균을 비롯한 그람양성균에 의한 빈도가 30-50%로 증가하였으며, 진균, 특히 캔디다균에 의한 감염증도 최근 5-12%로 증가한 것으로 보고되고 있다.',
  symptom: '혼미, 착란, 발작, 마비, 호흡곤란, 혈압저하',
...
},
{
  code: 242,
  name: '뇌수막염(소아)',
  cause: '바이러스, ���균, 진균, 기생충 같은 미생물에 의해 발생한다. 이��� 미생물은 우리 몸의 혈액 속으로 들어가 뇌척수액에 침입한다. 비감염성 뇌막염에는 암, 전신홍반루푸스, 특정 약물에 대한 염증 반응이 원인들이 될 수 있다.',
...
},
{
  ...
  symptom: '통증, 발진, 붉어짐, 가려움',
  core_symptom: '붉어짐, 발진, 가려움',
  part: '입, 생식기, 피부',
...
{
  code: 278,
  name: '무릎의 관절 및 인대의 탈구, 염좌 및 긴장',
  cause: '커다란 힘이 정상적인 한계를 넘어 무릎을 밀거나 구부릴 때 탈구된다.',
  symptom: '통증, 붓기',
  core_symptom: '통증, 붓기',
  part: '다리, 인대, 무릎',
  desc: '환부에 심한 충격을 받음',
...
{
  code: 281,
  name: '화농성 및 상세불명의 중이염',
  cause: '세균 감염이나 결핵균에 의한 만성 중이염',
  symptom: '분비물',
  core_symptom: '분비물',
  part: '귀',
  desc: '귀에서 농이 배출됨',
...
},
{
  code: 286,
  name: '비화농성 중이염',
  cause: '고막이 터지거나 귀에 상처가 남',
  symptom: '분비물,고름,통증,악취',
...
},
{
  code: 288,
  name: '만성 부비동염',
  cause: '바이러스 감염, 자극물질과의 접촉, 코 구조, 알레르기 등',
  symptom: '통증, 발열, 콧물, 분비물',
  core_symptom: '콧물, 통증',
  part: '코,머리',
  desc: '코가 막히고 숨쉬기 힘듦',
  img: 'https://raw.githubusercontent.com/TKvl6/myhand.nurseby/master/myhand.nurseby/assets/icon_png/077-runny_nose.png',
...
},
{
  code: 289,
  name: '자궁의 평활근종',
  cause: '원인은 불명이나, 가족력의 영향이 있음. 보통 가임기 여성에게 자주 발병',
  symptom: '생리,통증',
  core_symptom: '생리,통증',
  part: '생식기',
...
},
{
  code: 290,
  name: '농가진',
  cause: '고온다습하거나 위생상태가 불량한 환경에서, 아동들에게 자주 발생함',
  symptom: '물집, 수포,농포,고름,붓기',
...
},
{
  ...
  cause: '장이 꼬이거나 막혀, 배변과 가스가 장내에 축적됨',
  symptom: '통증',
  core_symptom: '통증,구토',
  part: '배',
  desc: '배에 Gas가 계속 참',
...
},
{
  code: 295,
  name: '무월경, 소량 및 희발 월경',
  cause: '난소의 발달이 미미하거나, 호르몬 분비 체계에 이상',
  symptom: '생리',
  core_symptom: '생리',
  part: '생식기',
...
},
{
  code: 304,
  name: '어깨병변',
  cause: '어깨 뼈의 노화, 혹은 심한 운동으로 힘줄 파열',
  symptom: '통증,불안정',
  core_symptom: '통증',
  part: '어깨',
...
},
{
  code: 314,
  name: '치아우식(충치)',
  cause: '형태적 특성 때문에 음식물과 미생물이 잘 끼게 되고 자정작용도 안되어 충치가 많이 발생한다.',
  symptom: '충치, 통증, 시림',
  core_symptom: '충치, 통증, 시림',
  part: '치아, 입',
  desc: '치아를 칫솔로 잘 안 닦음,',
...
},
{
  code: 318,
  name: '인두염',
  cause: '바이러스가 가장 흔한 원인, 건조한 공기에 장기간 노출되거나 기본적인 청결 상태유지가 안되었을 경우 발생',
  symptom: '콧물, 코막힘, 비염, 발열, 권태감, 식욕부진, 고열, 결막염, 발진, 설사, 대변',
...
},
{
  code: 319,
  name: '천식',
  cause: '집먼지 진드기, 꽃가루, 곰팡이, 애완동물, 바퀴벌레, 음식물, 비만',
  symptom: '호흡곤란, 기침, 천명, 호흡기 증상, 가래, 흉부 압박',
  core_symptom: '호흡곤란, 기침, 천명, 호흡기 증상, 가래, 흉부 압박',
  part: '목, 코, 가슴',
  desc: '폐 속에 있는 ���관지가 때떄로 좁아져서 호흡곤란, 기침, 천명 등 호흡기 증상이 반복적으로 그리고 갑작스롭게 발작적으로 나타난다.',
  img: 'https://raw.githubusercontent.com/TKvl6/myhand.nurseby/master/myhand.nurseby/assets/icon_png/031-asthma.png',
  score: 10
},
{
  code: 320,
  name: '연조직염',
  cause: '피부와 피하 조직에 생긴 급성 세균성 감염증으로, 세균이 침범한 부위가 빨갛게 되거나(홍반) 부종, 누를 때 통증(압통)이 생김',
  symptom: '홍반, 부종, 통증(압통),발열, 추위, 두통, 식욕부진, 염증',
...
{
  code: 321,
  name: '헤르페스바이러스[단순헤르페스] 감염',
  cause: '부모로부터 유아기에 첫 감염, 주로 원인 없는 열을 동반하면서 입안에 물집보다는 구내염처럼 동그랗고 하얀 구멍 같은 것이 생김',
  symptom: '입가에 물집, 궤양, 식욕 감퇴, 고열',
...
},
{
  code: 323,
  name: '치은염 및 치주질환',
  cause: '입 속에는 300여 종의 세균들이 살고 있으며, 음식 섭취 후 세균들이 타액 및 음식과 섞여서 치아에 부착되어 끈끈한 무색의 얇은 막을 만듭니다. 이와 같이 세균들이 덩어리져 치아면에 부착한 얇은 막을 치아면에 달라붙은 이끼와 비슷하다고 하여 치태(플라크)라고 부릅니다. 치아를 제대로 닦지 않음녀 치태가 그대로 굳어져서 딱딱한 돌처럼 되는 것을 치석이라고 하며 이러한 치석의 표면에 세균들은 더 쉽게 부착하여 번식함으로써 잇몸의 염증을 일으킵니다.',
  symptom: '잇몸의 염증, 잇몸의 피, 부음, 곪음, 치아 시림, 치조골 손상',
...
},
{
  code: 324,
  name: '급성 편도염',
  cause: '양측 편도에 세균이나 바이러스의 감염으로 발생한다. 추위나 더위에 노출되거나 감기 이후에 발생',
  symptom: '음식을 삼킬 때 통증, 두통, 전신위약감, 관절통, 편도 부음, 인후통, 구취',
...
},
{
  code: 326,
  name: '급성 세뇨관-간질신장염',
  cause: '약제 등에 의한 것이나 세뇨관 간질 조직의 독작용이나 면역력 저하',
  symptom: '발열, 피부 발진, 관절통, 혈뇨, 요통',
...
},
{
  code: 338,
  name: '림프절염',
  cause: '바이러스나 세균 같은 미생물 감염으로 인한 염증과 우리 몸에서 생겨난 자가면역반응에 의해 생기는 염증',
  symptom: '턱 밑의 림프절(임파선)이 부음, 목이 뻐근, 통증, 발열, 식은땀, 피로, 체중감소, 전신증상, 딱딱한 덩어리',
