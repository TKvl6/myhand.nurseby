/*
 * 예전 코드인데 혹시나 필요할 수도 있어서 남겨놨음
 */

module.exports.function = function searchDisease_backup(Part, Symptom) {
  ...
  console.log("part",tempResults.part)
  console.log("symptom",tempResults.symptom)
  console.log("core",tempResults.coreSymptom)
  console.log("core",tempResults.coreSymptom)
