module.exports = [{
  ...
  },
  {
    ...
    symptom: '피로감,메스꺼움,구토,식욕부진,발열,통증,황달,대변,소변',
    part: '배',
    desc: '검은 소변,탈색된 대변',
    score: 0
  },
  ...
  },
  {
    ...
    symptom: '기침,가래,출혈,발열,발한,쇠약,신경과민,식욕부진,소화불량,집중력 소실,식욕부진,구토,의식저하',
    part: '목,머리,소화',
    desc: '객혈(피가래)',
    score: 0
  },
  ...
  },
  {
    ...
    symptom: '두통, 오한, 근육통, 식욕 상실, 콧물, 후각 감퇴',
    part: '코,머리,근육',
    desc: '갑자기 코가 자주 막힘',
    score: 0
  },
  ...
  },
  {
    ...
    symptom: '피로감, 활동 시 호흡 곤란, 심계항진, 통증 ',
    part: '가슴',
    desc: ' ',
    score: 0
  },
  ...
  },
  {
    ...
    symptom: '오줌,부종,무기력,메스꺼움,구토, 빈혈',
    part: '방광',
    desc: '고혈압 환자,혈뇨,거품 많이 나오는 오줌',
    score: 0
  },
  {
    code: 137,
  ...
  },
  {
    ...
    symptom: '구역, 구토, 피곤함,황달,가려움,피부이상,발열',
    part: '피부,배',
    desc: '독한 약 섭취',
    score: 0
  },
  {
    ...
    symptom: '복부 불편감, 통증, 대변, 식욕부진, 현기증, 구토, 체중 감소, 혼수, 경련,쇠약,마비,관절통, 권태감, 불면증, 어지러움',
    part: '배,전신',
    desc: '오염된 지역 방문/거주 혹은 오염된 식품 섭취',
    score: 0
  },
  {
    code: 147,
  ...
  },
  {
    ...
    symptom: '통증,빈뇨,혈뇨,발열,체중 감소,빈혈,신기능 저하, 고혈압',
    part: '등,옆구리,방광',
    desc: '혈뇨, 용변 시 통증',
    score: 0
  },
  ...
  },
  {
    ...
    symptom: '기침, 가래, 호흡곤란, 발열, 체중 감소,출혈, 발한',
    part: '목,전신',
    desc: '피가래(혈담)',
    score: 0
  },
  {
    ...
    symptom: '발열,통증, 오한,안결막 충혈,발열, 수막염, 피부이상, 용혈성 빈혈,출혈, 간부전, 황달, 신부전, 심근염, 의식저하,황달,간부전, 신부전증,출혈,응고부전증,심장염,기침',
    part: '머리,근육,다리,피부',
    desc: '최근 야외 활동,심한 근육통(특히 종아리와 허벅지),피가래(객혈)',
    score: 0
  },
  {
    code: 157,
    ...
    symptom: '발열, 권태감, 통증, 졸림, 혼돈,신경마비,시야장애',
    part: '눈,머리',
    desc: '결핵 질환 보유',
    score: 0
  },
  ...
  },
  {
    ...
    symptom: '발열,통증, 구토,대변, 소화불량, 식욕부진, 무기력감, 불안, 초조감, 이통, 난청, 이명, 이루',
    part: '귀,머리',
    desc: '설사,귀에 다양한 증상',
    score: 0
  },
  {
    ...
    symptom: '호흡기 증상감기,통증, 콧물, 재채기, 코막힘,나른함,피로,붓기,관절이 무겁게 느껴짐, 위장 장애소화 불량, 불쾌',
    part: '머리, 코,배',
    desc: '에어컨 등 냉방 기구 오래 사용',
    score: 0
  },
  {
    code: 169,
    ...
    symptom: '발열, 오한, 불편감, 통증, 화농성 질 분비물',
    part: '배, 생식기',
    desc: '여성 질환, 분비물 악취',
    score: 0
  },
  ...
  },
  {
    ...
    symptom: '의식변화, 무력감, 어지러움, 구역, 구토, 통증, 졸림, 혼동상태, 근육떨림, 운동실조, 평형장애, 신경질, 고열, 의식장애, 덥고 건조한 피부, 헛소리, 혼수상태, 괴상한 행동, 환각상태, 근육 강직, 경련, 운동 실조, 땀, 출혈, 황달, 떨림, 의식 저하, 혼수',
    part: '머리,근육',
    desc: '뜨거운 환경에 장기간 노출',
    score: 0
  },
  {
    ...
    symptom: '통증,답답함,식욕저하, 구역, 구토, 소화기 증상, 권태감, 위약감, 소변양 감소, 수면장애, 마른기침, 호흡곤란, 폐수포음, 기침, 호흡곤란, 의식저하',
    part: '머리,가슴',
    desc: '현재 높은 곳에 위치함',
    score: 0
  },
  {
    ...
    symptom: '발적,통증,유방에 덩어리로 만져짐, 고름,분비물',
    part: '가슴,젖꼭지,유두,피부',
    desc: '유두 중심의 질환',
    score: 0
  },
  {
    ...
    symptom: '식욕부진, 메스꺼움, 구토, 피로감,통증,감기와 몸살 기운, 황달, 체중감소, 불쾌감',
    part: '관절,머리,근육,배',
    desc: 'B형 간염 질환 보유',
    score: 0
  },
  {
    ...
    symptom: '출혈, 권태감, 피로, 식욕부진, 피하출혈,소변,대변',
    part: '전신,입',
    desc: '균형잡힌 식사 불가,혈뇨,혈변',
    score: 0
  },
  {
    code: 203,
  ...
  },
  {
    ...
    symptom: '발열, 통증, 피부이상, 메슥거리움, 구토, 기침, 혼미, 경련, 콩팥기능 손상, 간기능 손상',
    part: '머리,근육,피부,배,가슴',
    desc: '쥐가 있는 환경, 오염된 섬유에서 생활',
    score: 0
  },
